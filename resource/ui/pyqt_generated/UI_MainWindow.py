...
"background-color: rgb(58, 58, 58);")
        ...
        self.verticalLayout_9.setContentsMargins(3, 3, 3, 0)
        self.verticalLayout_9.setSpacing(3)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.Horizontal_display_top = QtWidgets.QWidget(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Horizontal_display_top.sizePolicy().hasHeightForWidth())
        self.Horizontal_display_top.setSizePolicy(sizePolicy)
        self.Horizontal_display_top.setStyleSheet("border-width: 1px;\n"
"border-style: solid;\n"
"\n"
"")
        self.Horizontal_display_top.setObjectName("Horizontal_display_top")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.Horizontal_display_top)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.horizontalLayout_16 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_16.setContentsMargins(0, 9, 0, 9)
        self.horizontalLayout_16.setObjectName("horizontalLayout_16")
        self.label_status = QtWidgets.QLabel(self.Horizontal_display_top)
...
"font: 15pt \"黑体\";")
        ...
        self.pushButton_start = QtWidgets.QPushButton(self.Horizontal_display_top)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(14)
...
"font: 22pt \"黑体\";")
        ...
        self.verticalLayout_9.addWidget(self.Horizontal_display_top)
        self.horizontalLayout_display_center = QtWidgets.QHBoxLayout()
        self.horizontalLayout_display_center.setObjectName("horizontalLayout_display_center")
...
"")
        ...
        self.horizontalLayout_display_center.addLayout(self.verticalLayout_log_data_3)
        self.horizontalLayout_display_center.setStretch(0, 5)
        self.horizontalLayout_display_center.setStretch(1, 1)
        self.verticalLayout_9.addLayout(self.horizontalLayout_display_center)
        self.horizontalLayout_display_bottom = QtWidgets.QHBoxLayout()
        self.horizontalLayout_display_bottom.setObjectName("horizontalLayout_display_bottom")
        self.label_text_robotIP = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_text_robotIP.sizePolicy().hasHeightForWidth())
        self.label_text_robotIP.setSizePolicy(sizePolicy)
        self.label_text_robotIP.setObjectName("label_text_robotIP")
        self.horizontalLayout_display_bottom.addWidget(self.label_text_robotIP)
        self.label_robotIP = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_robotIP.sizePolicy().hasHeightForWidth())
        self.label_robotIP.setSizePolicy(sizePolicy)
        self.label_robotIP.setObjectName("label_robotIP")
        self.horizontalLayout_display_bottom.addWidget(self.label_robotIP)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_display_bottom.addItem(spacerItem3)
        self.label_text_mechIP = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_text_mechIP.sizePolicy().hasHeightForWidth())
        self.label_text_mechIP.setSizePolicy(sizePolicy)
        self.label_text_mechIP.setObjectName("label_text_mechIP")
        self.horizontalLayout_display_bottom.addWidget(self.label_text_mechIP)
        self.label_mechIP = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_mechIP.sizePolicy().hasHeightForWidth())
        self.label_mechIP.setSizePolicy(sizePolicy)
        self.label_mechIP.setObjectName("label_mechIP")
        self.horizontalLayout_display_bottom.addWidget(self.label_mechIP)
        self.verticalLayout_9.addLayout(self.horizontalLayout_display_bottom)
        ...
        self.action_open2DImageFile = QtWidgets.QAction(MainWindow)
        self.action_open2DImageFile.setCheckable(True)
        self.action_open2DImageFile.setObjectName("action_open2DImageFile")
        self.action_open3DCloudFile = QtWidgets.QAction(MainWindow)
        self.action_open3DCloudFile.setObjectName("action_open3DCloudFile")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_beatTime.setText(_translate("MainWindow", "0 ms"))
        ...
        self.label_text_runningTime.setText(_translate("MainWindow", "系统时间："))
        self.pushButton_login.setText(_translate("MainWindow", "操作员"))
        ...
        self.label_text_displayData.setText(_translate("MainWindow", "日志显示区"))
        self.label_text_robotIP.setText(_translate("MainWindow", "机器人IP："))
        self.label_robotIP.setText(_translate("MainWindow", "192.168.3.215:3000"))
        self.label_text_mechIP.setText(_translate("MainWindow", "Mech-Center IP:"))
        self.label_mechIP.setText(_translate("MainWindow", "127.0.0.1:50000"))
        ...
        self.action_open2DImageFile.setText(_translate("MainWindow", "打开2D图像"))
        self.action_open3DCloudFile.setText(_translate("MainWindow", "打开3D图像"))
